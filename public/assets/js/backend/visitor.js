            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'online_status', title: __('Online_status'), searchList: {"online":__('Online_status online'),"offline":__('Online_status offline')}, formatter: Table.api.formatter.status},
                        {field: 'client_id', title: __('Client_id')},
                        {field: 'kf_code', title: __('Kf_code')},
                        {field: 'kf_client_id', title: __('Kf_client_id')},
                        {field: 'pre_kf_code', title: __('Pre_kf_code')},
